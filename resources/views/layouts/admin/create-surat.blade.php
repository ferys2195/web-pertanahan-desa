                        ...
                        <div class="card-body">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $tanah->pemilik['nama'] }}"
                                        ...
                                        placeholder="Input nama pemilik .." required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                @php
                                ...
                                <div class="col-md-4">
                                    <input type="text" value="{{ $ttl[0] }}"
                                        class="form-control form-control-sm" name="tempat_lahir"
                                        placeholder="Tempat Lahir .." required>
                                </div>
                                <div class="col-md-4">
                                    <input type="date" value="{{ $tglLahir }}"
                                        class="form-control form-control-sm" name="tanggal_lahir"
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $tanah->pemilik['kewarganegaraan'] }}"
                                        class="form-control form-control-sm" name="kewarganegaraan" value="Indonesia"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text"
                                                value="{{ implode(',', $tanah->batas['selatan']) }}"
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $tanah->peruntukan }}" name="peruntukan"
                                        ...
                                        placeholder="Misal : Rumah, Perkebunan, dll" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3 d-flex align-items-center">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="is_hgu" type="radio"
                                            value="0">
