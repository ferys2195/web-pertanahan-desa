...
class GPointConverter
{
    ...
    public static $ellipsoid = [
        ...
        // Alternative names, added in for easy compatibility by hd@onlinecity.dk
        'ED50'                    => [6378388, 0.00672267], // International Ellipsoid
        'EUREF89'                => [6378137, 0.00669438], // Max deviation from WGS 84 is 40 cm/km see (in danish) http://www2.kms.dk/C1256AED004E87BA/(AllDocsByDocId)/3382517647F695C9C1256BC700265CE7
        'ETRS89'                => [6378137, 0.00669438],  // Same as EUREF89
    ];
    ...
    {
        echo 'Northing: '.(int) $this->utmNorthing.', Easting: '.(int) $this->utmEasting.', Zone: '.$this->utmZone;
    }
    ...
    {
        echo 'Northing: '.(int) $this->lccNorthing.', Easting: '.(int) $this->lccEasting;
    }
     ...
     *
     * @param  int  $falseEasting
     * @param  int  $falseNorthing
